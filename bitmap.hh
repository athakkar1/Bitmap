...
class bitmap {
 ...
 public:
  ...
  void random(uint32_t x, uint32_t y, uint32_t w, uint32_t h, uint32_t color);
  ...
  void half_circle(uint32_t x, uint32_t y, uint32_t d, uint32_t color);
  ...
  // uint32_t
  //  findcolor, uint32_t replace_color);
};
